...
export const metadata: Metadata = {
  ...
  title: "Contact",
  description:
    "Discuss an insurance, risk, actuarial or regulatory requirement with Alpha Consultant. Based at 139 Cecil Street, Singapore, serving clients across Asia Pacific.",
